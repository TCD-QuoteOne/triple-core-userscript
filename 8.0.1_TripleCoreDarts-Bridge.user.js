...
(function () {
    ...
    const LobbyFlow = {
        ...
        async handleCreatedLobby() {
            ...
            const payload = {
                ...
                season_match_id: State.activeSeasonMatchId || leagueJob?.season_match_id || context?.season_match_id || null,
                season_id: leagueJob?.season_id || context?.season_id || null,
                job_id: leagueJob?.id || casualJob?.id || context?.job_id || null,
            ...
            await ApiBridge.tcPost(CONFIG.ENDPOINTS.BRIDGE_LOBBY, payload);
    ...
    async function refreshSeasonAndJobs() {
        ...
        try {
            ...
            if (!State.openLeagueJob && leagueContextActive) {
